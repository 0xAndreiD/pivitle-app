...
const CodeHistory = ({ generateCodeHistoryResponse, history }) => {
  const [newCodeHistoryQuestion, setNewCodeHistoryQuestion] = useState(
    history.question
  );
      ...
      <div className="timeline-item">
        <div className="row">
          ...
          <div className="col-7 content">
            <a onClick={() => setHistory()}>{history.question}</a>
          </div>
        </div>
      </div>
    </>
